...
from laser_phase_one_cav import LaserPhase
...
class LaserPhaseCali(LaserPhase):
    ...
    def write_phase_cali(self,length):
        ...
        d0 = self.prep_pm_one_cav_new(self.dac_len,v,0)#PM for zero
        d1 = self.prep_am_one_cav_new(self.dac_len)
